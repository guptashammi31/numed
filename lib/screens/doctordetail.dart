...
void confirm (){
  AlertDialog alertDialog = new AlertDialog(
    content: new Text("Ready to Book Dr. '${widget.list[widget.index]['item_name']}'"),
    actions: <Widget>[
      new RaisedButton(
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child:Text("${widget.list[widget.index]['item_name']}",
                            style: TextStyle(
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child:
                                  ...
                                  Text("  ${widget.list[widget.index]['stock']} years of experience ",
                                  //   maxLines: 5,
                                    style: TextStyle(
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    Row(children: <Widget>[
                                      ...
                                      Text(
                                        "₹${widget.list[widget.index]['price']}",style: TextStyle(
                                        fontSize: 12.0,
                                      ),
                                      ),],),),],
                              ),)],),),
              ...
              children: <Widget>[
                Container(
                  ...
                  Row(children: <Widget>[
                    ...
                    Text(
                      _changeformatdate,style: TextStyle(
                      fontSize: 16.0,                              color: Color(0xFF21BFBD),
